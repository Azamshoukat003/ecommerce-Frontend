...
//   const discountPercent = parseFloat(product.productDiscountPrice) || 0;
...
//   return (
//     <div
//       className="rounded-xl bg-gray-100 dark:bg-gray-800 shadow hover:shadow-lg transition  flex flex-col cursor-pointer"
...
//       <h3 className="text-lg font-semibold mb-2 ml-3">{product.productName}</h3>
...
//       {/* Model & Category */}
//       <p className="text-sm text-gray-600 dark:text-gray-400 mb-2 ml-3">
//         {product.productModel.modelName} •{" "}
//         {product.productCategory?.categoryName || ""}
//       </p>

//       <button className="mt-auto bg-indigo-600 text-white py-2 rounded hover:bg-indigo-500">
//         Add to Cart
//       </button>
...
//         }}
//         className="mt-2 bg-indigo-600 text-white py-2 rounded hover:bg-indigo-500"
//       >
//         View Details
//       </button>
//     </div>
